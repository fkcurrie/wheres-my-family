...
if (rootContent && webContent) {
  ...
  if (rootContent === webContent) {
    ...
    console.warn(
      ' ⚠️ Drift Detected: dashboard.html and web-dashboard/index.html have content differences.'
    );
    console.warn(
      '    (The orchestrator will automatically resolve this on next run by copying the web dashboard over the root)'
    );
  }
}
