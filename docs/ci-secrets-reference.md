...
- **Windows PowerShell:**
  ...
  ```
  _(Crucial: Verify the output file does not contain carriage return `\r\n` line wraps or trailing white spaces.)_
...
- **Windows PowerShell:**
  ...
  ```
  _(If `keytool` prompts for your password and prints your key fingerprint successfully, your base64 string is 100% valid!)_
